export const colors = {
  child: { sky: '#4EC3E0', skyDeep: '#1E93B5', sun: '#FFC93E', coral: '#FF6B57', grass: '#6BCB77', plum: '#7C5CBF', cream: '#FFF8EC' },
  parent: { paper: '#F4F1EB', night: '#2A3B5C', card: '#FFFFFF', hairline: '#F0EBE1', muted: '#8A8090' },
  player: { bg: '#1B2233' },
  state: { review: { bg: '#FFC93E', text: '#7A5C00' }, live: { bg: '#6BCB77', text: '#FFFFFF' } },
  bg: '#F4F1EB',
  canvas: '#F3EDE3',
  card: '#FFFFFF',
  ink: '#2A3B5C',
